...
export class ProdutoUpdateComponent implements OnInit {
  ...
  constructor(private api: ZipInCloudService, private toast: ToastrService, private route: ActivatedRoute, private router: Router, private domSanitizer: DomSanitizer) {}
  ...
  async ngOnInit() {
    ...
    await this.api.prodPorCodigo(this.route.snapshot.paramMap.get("codigo")).then((data) => {
      this.produto = data;
